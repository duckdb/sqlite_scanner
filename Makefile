...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="sqlite_scanner" -DDUCKDB_OOT_EXTENSION_SQLITE_SCANNER_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_SQLITE_SCANNER_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_SQLITE_SCANNER_INCLUDE_PATH="$(PROJ_DIR)src/include"
